...
func renderHelp(width, height int) string {
	...
	lines := []string{
		...
		"  " + styles.FooterKeyStyle.Render("e") + styles.FooterStyle.Render("         View session details"),
		...
		"  " + styles.FooterKeyStyle.Render("d") + styles.FooterStyle.Render("         Delete selected session(s)"),
		"",
